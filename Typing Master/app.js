const input_keyboard = document.getElementById("word_Input");
const timer = document.getElementById("timer");
const score = document.getElementById("score");
const word = document.getElementById("word");
const play = document.querySelector(".game_Start button");
...
function typingGame() {
    play.disabled = true;
    input_keyboard.disabled = false;
    word.innerText = list[Math.floor(Math.random()*list.length)];
    if (game === true) {
        input_keyboard.oninput = function() {
            if(word.innerText == input_keyboard.value){
                switch (myscore) {
                    case 3:
